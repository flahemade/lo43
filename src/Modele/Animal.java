...
/** va permettre Ã  l'animal de choisir une nouvelle position sur la map
 *@param p
...
public Element live(Case c){
  ...
  protected Position choixDeplacement (ArrayList<Case> listecaseadj){
	 // System.out.println("Pas la bonne mÃ©thode");
	  return position;
  }

  /*_______________________________________________________________*/
/**fonction redÃ©finie dans les classes filles
 * @param ressource
 */
